...
n_json_manager_set_n_list (NJsonManager *self, GList *n_list)
{
    ...
    if (!self->n_list)
        {
            g_warning ("n_json_set_n_list: setting n_list failed");
            return -1;
        }
    return 0;
}
...
n_json_manager_n_object_to_json_node (NObject *n_object, JsonNode *j_node)
{
    ...
    json_builder_add_string_value (builder, n_object_get_body (n_object));
    json_builder_set_member_name (builder, "message");
    json_builder_add_string_value (builder, n_object_get_message (n_object));
    json_builder_set_member_name (builder, "summary");
    json_builder_add_string_value (builder, n_object_get_summary (n_object));
    json_builder_set_member_name (builder, "appname");
    json_builder_add_string_value (builder, n_object_get_appname (n_object));
    json_builder_set_member_name (builder, "category");
    json_builder_add_string_value (builder, n_object_get_category (n_object));
    json_builder_set_member_name (builder, "default_action_name");
    json_builder_add_string_value (
        builder, n_object_get_default_action_name (n_object)
    );
    json_builder_set_member_name (builder, "icon_path");
    json_builder_add_string_value (builder, n_object_get_icon_path (n_object));
    json_builder_set_member_name (builder, "id");
    json_builder_add_int_value (builder, n_object_get_id (n_object));
    json_builder_set_member_name (builder, "timestamp");
    json_builder_add_int_value (builder, n_object_get_timestamp (n_object));
    json_builder_set_member_name (builder, "timeout");
    json_builder_add_int_value (builder, n_object_get_timeout (n_object));
    json_builder_set_member_name (builder, "progress");
    json_builder_add_int_value (builder, n_object_get_progress (n_object));
...
static void
n_json_manager_parser_get_array_from_root (
...
static void
n_json_manager_parser_get_array_from_file (
